...
FigString='7E'; % set to FigString='' to specify your own values
p0=zeros(1,24);
switch FigString 
...
for tsIdx=1:length(tsaveIdx)
    ...
    set(gcf,'units','centimeters','position',[10,20,6.4,12.8]);
...
set(gcf,'units','centimeters','position',[10,10,6.4,5.6]);
drawnow;pause(0.1)
plot([0,700],[1,1],'color',red)
plot(tint(tsaveIdx),ActAreaTH/FFArea,'color',dark_green,'linewidth',1.5)
plot(tint(tsaveIdx),SelAreaTH/FFArea,'color',blue,'linewidth',1.5)
...
axis equal
set(gcf,'units','centimeters','position',[10,20,6.4,6.4]);
drawnow;pause(0.1)
